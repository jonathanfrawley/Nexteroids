...
**/
#ifndef  NXMAINMENUGAMEVIEW_H
#define  NXMAINMENUGAMEVIEW_H
...
/*
 * =====================================================================================
 *        Class: nxMainMenuGameView
 *  Description:
 * =====================================================================================
 */
class nxMainMenuGameView : public nxHumanView
{
	public:
		nxMainMenuGameView();

		virtual ~nxMainMenuGameView();

		bool Init();

		void ShowLoadingScreen();
		
        void ListenForMainMenuGameViewEvents();
